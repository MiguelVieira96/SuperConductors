            ...
            <div class="form-group">
              <div class="row row-form">
                ...
                <div class="col-input-login">
                  <input type="text" class="register-name" id="name" name="name" placeholder="Your Name">
                </div>
              </div>
              <div class="row row-form">
                <div class="col-label-login">
              ...
              <div class="row row-form">
                ...
                <div class="col-input-login input-group" id="show_hide_password">
                  <input class="from-control" type="password" id="register-password" name="password" placeholder="Password">
